...
const greeting = {
  ...
  subTitle: emoji(
    "Aspiring Software Developer 🚀 pursuing an MSc in Software Development at the University of Glasgow. Interested in building web applications and transitioning from a language background."
  ),
